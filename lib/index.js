...
var Logger = /** @class */ (function () {
    ...
    Logger.prototype.log = function (level, message, context) {
        return __awaiter(this, void 0, void 0, function () {
            var fullMessage, consoleFunction, entry, _i, _a, transport;
            return __generator(this, function (_b) {
                ...
                for (_i = 0, _a = this.config.transports; _i < _a.length; _i++) {
                    transport = _a[_i];
    ...
    Logger.prototype.child = function (defaultContexts) {
        return new Logger(__assign(__assign({}, this.config), { defaultContext: __assign(__assign({}, this.config.defaultContext), defaultContexts) }));
    };
    Logger.prototype.addTransport = function (transport) {
        this.config.transports.push(transport);
    };
    Logger.prototype.removeTransport = function (transport) {
        this.config.transports = this.config.transports.filter(function (item) { return item !== transport; });
    };
    return Logger;
}());
